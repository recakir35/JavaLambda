...
public class C01_stream_foreach {
    public static List<Integer> sayi = new ArrayList<>(Arrays.asList(34, 22, 16, 11, 35, 20, 63, 21, 65, 44, 66, 64, 81, 38, 15));
    ...
    /*
        ...
        */
        ...
        System.out.println("\n");
        sayi.stream().forEach(C_Utilities::yazdir);//method reference--> System.out yapısında prin methodu refere et
    }
